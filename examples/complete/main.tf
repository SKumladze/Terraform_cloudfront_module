...
locals {
  domain_name = "sosokumladze.com" # trimsuffix(data.aws_route53_zone.this.name, ".")
  subdomain   = "test"
}
...
module "cloudfront" {
  ...
  viewer_certificate = {
    acm_certificate_arn = "arn:aws:acm:us-east-1:125016454925:certificate/5683b74e-d00c-4219-8ac9-9ea9b834b592" #module.acm.acm_certificate_arn
